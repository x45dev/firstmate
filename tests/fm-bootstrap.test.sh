...
unsupported pi effort is flagged^{"rules":[{"when":"bad pi effort","use":{"harness":"pi","model":"anthropic/claude-sonnet-5","effort":"garbage"}}]}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - invalid effort: pi:garbage
