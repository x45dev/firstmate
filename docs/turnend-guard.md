...
The episode record is judged by the same liveness standard as the claim and carries no clock of its own: it ends the moment its publisher dies or changes, so a crashed or timed-out hook is not a hang and a later claim starts a new episode.
