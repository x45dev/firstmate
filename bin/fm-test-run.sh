...
family_for_basename() {
  case "$1" in
    ...
    fm-test-run.test.sh|fm-test-isolation-proof.test.sh)
      printf '%s\n' pure-contract-unit
      ;;
    fm-allowance-park.test.sh|\
    fm-daemon.test.sh|fm-guard-stale-banner.test.sh|fm-pi-watch-extension.test.sh|\
    fm-session-lock-ancestry.test.sh|fm-cursor-primary.test.sh|\
    fm-supervision-events.test.sh|fm-turnend-guard.test.sh|fm-wake-daemon-lifecycle-e2e.test.sh|\
    fm-wake-drain-unread-status.test.sh|\
    fm-contact-live-check.test.sh|fm-tool-update-check.test.sh|\
    ...
    fm-claude-stop-autoarm-live-e2e.test.sh|fm-claude-stopfailure-rewake-live-e2e.test.sh|\
...
tests/fm-claude-stopfailure-rewake-live-e2e.test.sh 21
...
tests/fm-progress-lib.test.sh 400
tests/fm-progress-live-e2e.test.sh 20
