...
state/               runtime records and signals; gitignored
  ...
  <id>.progress-sample  the last movement sample of this task's rendered pane and the verdict it established; bin/fm-progress-lib.sh owns the record and the four verdicts, and is the single source of positive movement evidence for both the wedge bound and the busy-marker check; removed by teardown
